...
//     else navigate(`/complianceresult/${docId}`);
//   };
...
//           <button
//             onClick={handleback}
//             className="absolute top-4 right-4 flex items-center gap-1 text-sm text-blue-600 font-medium"
//           >
//             <ChevronLeft size={18} />
//             Back
//           </button>
...
//           <div className="mt-4 bg-white/60 rounded-xl px-4 py-3 text-sm border border-[#9AD8FB]">
//             <p className="text-gray-500">Referenced From:</p>
//             <p className="text-gray-700 mt-1 font-medium flex flex-wrap gap-2 items-center">
...
//                 <span className="text-sm text-gray-700">Retrain AI</span>
//                 <Switch
//                   checked={retrainLLM}
//                   onChange={(e) => setRetrainLLM(e.currentTarget.checked)}
//                 />
//               </div>
...
//           {question?.answer_modified && (
//             <div className="py-3 text-sm font-medium text-blue-600">
//               Modified Answer
//             </div>
//           )}
