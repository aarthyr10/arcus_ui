...
//   name: string;
//   date: string;
//   status: "processed" | "pending" | "failed";  // Add status prop
// }

// const UploadItem = ({ name, date }: UploadItemProps) => {
//   return (
//     <div
//       className="
...
import { Eye, FileText, RefreshCw, CheckCircle, Clock, XCircle } from "lucide-react";
